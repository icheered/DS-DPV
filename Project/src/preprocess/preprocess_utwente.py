...
# Function to extract the study code
def extract_study_code(s):
    return s.split(' ')[0]
activities['study'] = activities['name'].apply(extract_study_code)


# Save data to file
activities.to_csv(outputpath+'activities.csv', index=False)
